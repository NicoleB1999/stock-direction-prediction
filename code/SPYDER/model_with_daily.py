...
# הורדתי את 'stock_return' כי זה מה שאנחנו מנסים לחזות (התשובה)
# הורדתי את 'date' ו-'symbol' כי המודל לא יכול לעשות חישובים על טקסט/תאריך
X = df.drop(columns=['stock_return', 'date', 'symbol'], errors='ignore')
y = df['stock_return']
